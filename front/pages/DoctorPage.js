...
const DoctorPage = () => {
    ...
    const onDataBinding=()=> {
        ...
        console.log( scheduleObj.workDays)
    ...
    useEffect(() => {
        ...
        fetchOneDoctor(id).then(doctorObj => {setDoctorObj(doctorObj)
    ...
    {
        // if(newWeekend.length !==0) {
        //     await deleteTimetable(newWeekend.id)
        // }
        ...
        <Container >
            ...
            <Row className='doctor-detail'>
                    ...
                    <div >
                        <div className='col-lg-12 control-section'>
                            <div className='control-wrapper'>
                                ...
                                >
                                    <ResourcesDirective>
                                        <ResourceDirective field='DoctorId' title='Doctors' name='Doctors' allowMultiple={true}
                                                           dataSource={doctorObj} textField='text' idField='id' colorField='color'
                                        >
                                        </ResourceDirective>
                                    </ResourcesDirective>
                ...
                <Modal show={show1} onHide={handleCloses}>
                    ...
                    <Modal.Footer>
                        <Button  onClick={putTimetable}>Save</Button>
