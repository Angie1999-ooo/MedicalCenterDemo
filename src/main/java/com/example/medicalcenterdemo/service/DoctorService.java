...

{
    ...
    public Long delete(Long id) {
        ...
        List<Timetable> timetable = timetableRepository.findByDoctor(doctor.get());

        timetableRepository.deleteAll(timetable);

        List<Acceptance> acceptanceList = acceptanceRepository.findByDoctor(doctor.get());

        acceptanceRepository.deleteAll(acceptanceList);
